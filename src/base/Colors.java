...
public interface Colors {
	...
	public static final Color BACKGROUND_C = Color.web("#0e0e0e");
	public static final Color COLOR_RED_C = Color.web("#FF554D");
	public static final Color COLOR_ORANGE_C = Color.web("#FCA103");
	public static final Color COLOR_YELLOW_C = Color.web("#F0FC03");
	public static final Color COLOR_GREEN_C = Color.web("#7FFC03");
}
